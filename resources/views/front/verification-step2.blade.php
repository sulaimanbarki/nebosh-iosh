...
<head>
    ...
    <style>
        @media (min-width: 800px) {
            .sections-container[_ngcontent-ng-c4267814302] {
                display: grid;
        ...
        .fields-container[_ngcontent-ng-c4267814302] {
            width: calc(100% - 20px);
            display: flex;
        ...
        .field-container[_ngcontent-ng-c4267814302] {
            display: grid;
            width: 100%;
        ...
        .field-container[_ngcontent-ng-c4267814302]>div[_ngcontent-ng-c4267814302] {
            margin-bottom: 10px;
            height: 100%
        }

        .highlighted[_ngcontent-ng-c4267814302] {
            font-weight: 400;
            border-radius: 20px;
            padding: 20px;
        ...
        @media (min-width: 800px) {
            .auth-section[_ngcontent-ng-c4267814302] {
                display: grid;
        ...
        .auth-container[_ngcontent-ng-c4267814302] {
            max-width: 500px;
            width: 100%;
            display: flex;
            flex-direction: column;
        ...
        .auth-inputs[_ngcontent-ng-c4267814302] {
            margin-top: 20px;
            width: 100%;
            display: flex;
            flex-direction: row;
        ...
        .mat-mdc-form-field-subscript-wrapper[_ngcontent-ng-c4267814302] {
            height: 0px
        }
    </style>
    <style>
...
<body class="mat-typography">
    <app-root _nghost-ng-c3885976823="" ng-version="17.3.5">
        <div _ngcontent-ng-c3885976823="" style="width: 100%; display: flex; justify-content: center; flex-wrap: wrap;">
            <img _ngcontent-ng-c3885976823="" src="assets/NeboshLogo.jpg" style="width: 250px;"></div><router-outlet
            _ngcontent-ng-c3885976823=""></router-outlet><app-confirm-request _nghost-ng-c4267814302=""><!---->
            <div _ngcontent-ng-c4267814302="">
                <div _ngcontent-ng-c4267814302="" class="sections-container">
                    <div _ngcontent-ng-c4267814302=""></div>
                    <div _ngcontent-ng-c4267814302="" class="fields-container">
                        <h3 _ngcontent-ng-c4267814302="">Details Requested</h3>
                        <div _ngcontent-ng-c4267814302="" class="field-container">
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Certificate Name:
                                </strong></div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> Hasnat Amin </div>
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Certificate Date:
                                </strong></div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> 06/09/2024 </div>
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Qualification:
                                </strong></div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> NEBOSH International General Certificate in Occupational
                                Health and Safety </div>
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Master log
                                    certificate No: </strong></div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> 00802349/1450438 </div>
                        </div>
                    </div>
                    <div _ngcontent-ng-c4267814302=""></div>
                    <div _ngcontent-ng-c4267814302="" class="fields-container">
                        <h3 _ngcontent-ng-c4267814302="">Requester Details</h3>
                        <div _ngcontent-ng-c4267814302="" class="field-container">
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Requested By:
                                </strong></div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> Muhammad Suliman </div>
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Organisation:
                                </strong></div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> Barki IT Solutions </div>
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Email: </strong>
                            </div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> sulaimanbarki@gmail.com </div>
                            <div _ngcontent-ng-c4267814302=""><strong _ngcontent-ng-c4267814302="">Requested: </strong>
                            </div>
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""> 07/12/2024 13:03 </div>
                        </div>
                    </div>
                    <div _ngcontent-ng-c4267814302=""></div>
                </div>
                <div _ngcontent-ng-c4267814302="" class="auth-section">
                    <div _ngcontent-ng-c4267814302=""></div>
                    <div _ngcontent-ng-c4267814302="" class="auth-container">
                        <div _ngcontent-ng-c4267814302="" class="highlighted">
                            <h4 _ngcontent-ng-c4267814302="">If you consent to this verification, please enter the
                                authentication code provided to you by email in the space below and click 'Accept'</h4>
                            <h4 _ngcontent-ng-c4267814302="">If you do NOT consent to this verification, please enter
                                the authentication code provided to you by email in the space below and click 'Deny'
                            </h4>
                        </div>
                        <div _ngcontent-ng-c4267814302="" class="auth-inputs">
                            <div _ngcontent-ng-c4267814302=""><mat-form-field _ngcontent-ng-c4267814302=""
                                    subscriptsizing="dynamic"
                                    class="mat-mdc-form-field mat-mdc-form-field-type-mat-input mat-form-field-appearance-fill mat-form-field-hide-placeholder mat-primary ng-untouched ng-pristine ng-valid ng-tns-c3736059725-0"><!---->
                                    <div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled">
                                        ...
                                        <div class="mat-mdc-form-field-flex"><!----><!----><!---->
                                            <div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel=""
                                                    ...
                                                    id="mat-mdc-form-field-label-0" for="mat-input-0"><mat-label
                                                        _ngcontent-ng-c4267814302="">Auth.
                                                        Code</mat-label><!----></label><!----><!----><!----><input
                                                    _ngcontent-ng-c4267814302="" matinput=""
                                                    placeholder="Authentication code..."
                                                    class="mat-mdc-input-element ng-untouched ng-pristine ng-valid mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored"
                                                    id="mat-input-0" aria-invalid="false" aria-required="false">
                                            </div><!----><!---->
                                        </div>
                                    ...
                                    <div
                                        class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align mat-mdc-form-field-subscript-dynamic-size">
                            ...
                            <div _ngcontent-ng-c4267814302="" style="flex-grow: 1;"></div>
                            <div _ngcontent-ng-c4267814302=""><button _ngcontent-ng-c4267814302=""
                                    mat-raised-button="" style="color: red;" mat-ripple-loader-uninitialized=""
                                    mat-ripple-loader-class-name="mat-mdc-button-ripple"
                                    class="mdc-button mdc-button--raised mat-mdc-raised-button mat-mdc-button-disabled mat-unthemed mat-mdc-button-base"
                                    mat-ripple-loader-disabled="" disabled="true"><span
                                        class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><mat-icon
                                        _ngcontent-ng-c4267814302="" role="img"
                                        class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color"
                                        aria-hidden="true" data-mat-icon-type="font">cancel</mat-icon><span
                                        class="mdc-button__label">Deny</span><span
                                        class="mat-mdc-focus-indicator"></span><span
                                        class="mat-mdc-button-touch-target"></span></button> &nbsp; <button
                                    _ngcontent-ng-c4267814302="" mat-raised-button="" style="color: green;"
                                    ...
                                    mat-ripple-loader-disabled="" disabled="true"><span
                                        ...
                                        _ngcontent-ng-c4267814302="" role="img"
                                        class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color"
                                        aria-hidden="true" data-mat-icon-type="font">check</mat-icon><span
                                        class="mdc-button__label">Accept</span><span
                                        class="mat-mdc-focus-indicator"></span><span
    ...
    <script>
      window.onload = function() {
          ...
          // setTimeout(function() {
              ...
              var registrationNo = record?.uuid ? record.uuid : '';

              // Construct the new URL
              var baseUrl = window.location.href.replace(/\/$/, ''); // Remove trailing slash if it exists
              var newUrl = `${baseUrl}/ConfirmRequest/${registrationNo}`;
