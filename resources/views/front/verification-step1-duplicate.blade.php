...
<head>
  ...
  <link rel="stylesheet" href="styles-LIYTL6VP.css" media="all" onload="this.media='all'"><noscript>
    <link rel="stylesheet" href="styles-LIYTL6VP.css">
  </noscript>
  <link rel="modulepreload" href="chunk-O2QDAK4C.js">
  <style type="text/css"></style>
  <style>
    .fields-container[_ngcontent-ng-c3871411255] {
      width: 100%;
      display: flex;
      align-items: center;
    ...
    h3[_ngcontent-ng-c3871411255],
    h5[_ngcontent-ng-c3871411255] {
      max-width: 500px;
      width: 100%
    }

    .text-center[_ngcontent-ng-c3871411255] {
      text-align: center
    }

    .text-left[_ngcontent-ng-c3871411255] {
      text-align: left
    }

    .text-right[_ngcontent-ng-c3871411255] {
      text-align: right
    }

    .nav-container[_ngcontent-ng-c3871411255] {
      max-width: 500px;
      width: 100%;
      display: flex;
      margin-top: 40px
    ...
    .field-container[_ngcontent-ng-c3871411255] {
      max-width: 500px;
      width: 100%
    }

    .full-width[_ngcontent-ng-c3871411255] {
      width: 100%
    }
  </style>
  <style>
  ...
  <style>
    ...
    .mdc-switch .mdc-switch__ripple {
      height: var(--mdc-switch-state-layer-size);
      width: var(--mdc-switch-state-layer-size)
    }
    ...
    .mdc-switch__track::after,
    .mdc-switch__track::before {
      border-width: var(--mat-switch-track-outline-width);
      border-color: var(--mat-switch-track-outline-color)
    }
  ...
  <style>
    ...
    .mdc-form-field {
      font-family: var(--mdc-form-field-label-text-font);
      line-height: var(--mdc-form-field-label-text-line-height);
      font-size: var(--mdc-form-field-label-text-size);
      font-weight: var(--mdc-form-field-label-text-weight);
      letter-spacing: var(--mdc-form-field-label-text-tracking);
...
<body class="mat-typography" data-new-gr-c-s-check-loaded="14.1214.0" data-gr-ext-installed="">
  <app-root _nghost-ng-c2283532919="" ng-version="17.3.12">
    <app-image-header _ngcontent-ng-c2283532919="" _nghost-ng-c3464553910="">
      <div _ngcontent-ng-c3464553910="" style="width: 100%; display: flex; justify-content: center; flex-wrap: wrap;">
        <img _ngcontent-ng-c3464553910="" src="assets/NeboshLogo.jpg" style="width: 250px;"></div>
    </app-image-header>
    <router-outlet _ngcontent-ng-c2283532919=""></router-outlet>
    <app-validation _nghost-ng-c3871411255="">
      <mat-stepper _ngcontent-ng-c3871411255="" role="tablist" linear="" aria-orientation="horizontal"
        class="mat-stepper-horizontal mat-stepper-label-position-end ng-tns-c3820311392-0">
        <!---->
        <div class="mat-horizontal-stepper-wrapper">
          <div class="mat-horizontal-stepper-header-container">
            <mat-step-header role="tab" class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="0"
              id="cdk-step-label-0-0" aria-posinset="1" aria-setsize="4" aria-controls="cdk-step-content-0-0"
              aria-selected="true">
              ...
              <div class="mat-step-icon mat-step-icon-state-number mat-step-icon-selected">
                <div class="mat-step-icon-content"><span aria-hidden="true">1</span>
                  <!---->
                  <!---->
                  <!---->
                  <!---->
              ...
              <div class="mat-step-label mat-step-label-active mat-step-label-selected">
                <div class="mat-step-text-label">Disclaimer</div>
                <!---->
                <!---->
                <!---->
                <!---->
            ...
            <!---->
            <mat-step-header role="tab" class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="-1"
              id="cdk-step-label-0-1" aria-posinset="2" aria-setsize="4" aria-controls="cdk-step-content-0-1"
              aria-selected="false" aria-disabled="true">
              <div matripple="" class="mat-ripple mat-step-header-ripple mat-focus-indicator"></div>
              <div class="mat-step-icon mat-step-icon-state-number">
                <div class="mat-step-icon-content"><span aria-hidden="true">2</span>
                  <!---->
                  <!---->
                  <!---->
                  <!---->
              ...
              <div class="mat-step-label">
                <div class="mat-step-text-label">Your Details</div>
                <!---->
                <!---->
                <!---->
                <!---->
            ...
            <!---->
            <mat-step-header role="tab" class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="-1"
              id="cdk-step-label-0-2" aria-posinset="3" aria-setsize="4" aria-controls="cdk-step-content-0-2"
              aria-selected="false" aria-disabled="true">
              <div matripple="" class="mat-ripple mat-step-header-ripple mat-focus-indicator"></div>
              <div class="mat-step-icon mat-step-icon-state-number">
                <div class="mat-step-icon-content"><span aria-hidden="true">3</span>
                  <!---->
                  <!---->
                  <!---->
                  <!---->
              ...
              <div class="mat-step-label">
                <div class="mat-step-text-label">Learner Details</div>
                <!---->
                <!---->
                <!---->
                <!---->
            ...
            <!---->
            <mat-step-header role="tab" class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="-1"
              id="cdk-step-label-0-3" aria-posinset="4" aria-setsize="4" aria-controls="cdk-step-content-0-3"
              aria-selected="false" aria-disabled="true">
              <div matripple="" class="mat-ripple mat-step-header-ripple mat-focus-indicator"></div>
              <div class="mat-step-icon mat-step-icon-state-number">
                <div class="mat-step-icon-content"><span aria-hidden="true">4</span>
                  <!---->
                  <!---->
                  <!---->
                  <!---->
              ...
              <div class="mat-step-label">
                <div class="mat-step-text-label">Finished</div>
                <!---->
                <!---->
                <!---->
                <!---->
          ...
          <div class="mat-horizontal-content-container">
            <div role="tabpanel" class="mat-horizontal-stepper-content ng-trigger ng-trigger-horizontalStepTransition"
              id="cdk-step-content-0-0" aria-labelledby="cdk-step-label-0-0"
              style="transform: none; visibility: inherit;">
              <form _ngcontent-ng-c3871411255="" novalidate="" class="ng-untouched ng-pristine ng-invalid">
                <div _ngcontent-ng-c3871411255="" class="fields-container">
                  <h3 _ngcontent-ng-c3871411255="" class="text-center">IMPORTANT, PLEASE READ BEFORE CONTINUING</h3>
                  <h5 _ngcontent-ng-c3871411255="" class="text-left"> NEBOSH takes the security of personal data and
                    NEBOSH certificates extremely seriously. As part of the verification process, NEBOSH will email the
                    learner that was originally issued this certificate to authenticate your request. </h5>
                  <h5 _ngcontent-ng-c3871411255="" class="text-left"> To allow the learner to identify who is requesting
                    information relating to them, your name and organisation will be provided to the learner to allow
                    them to authorise your request. </h5>
                  <h5 _ngcontent-ng-c3871411255="" class="text-left"> Your email address will be used by NEBOSH to
                    confirm the outcome of your request within 2 working days of submission. </h5>
                  <h5 _ngcontent-ng-c3871411255="" class="text-left"><strong _ngcontent-ng-c3871411255="">Please note:
                    </strong>The outcome of this request will be recorded and held by NEBOSH for monitoring purposes.
                    This includes your name, organisation and email address. Please tick the box below to confirm your
                    acceptance or contact NEBOSH </h5>
                  <div _ngcontent-ng-c3871411255="" class="field-container">
                    <mat-slide-toggle _ngcontent-ng-c3871411255="" formcontrolname="accepted"
                      id="mat-mdc-slide-toggle-1" required=""
                      class="mat-mdc-slide-toggle mat-accent ng-untouched ng-pristine ng-invalid">
                      <div mat-internal-form-field="" class="mdc-form-field mat-internal-form-field"><button
                          role="switch" type="button" class="mdc-switch mdc-switch--unselected" tabindex="0"
                          id="mat-mdc-slide-toggle-1-button" aria-labelledby="mat-mdc-slide-toggle-1-label"
                          aria-required="true" aria-checked="false">
                          ...
                          <div class="mdc-switch__handle-track">
                            <div class="mdc-switch__handle">
                              ...
                              <div class="mdc-switch__ripple">
                                <div mat-ripple=""
                                  class="mat-ripple mat-mdc-slide-toggle-ripple mat-mdc-focus-indicator"></div>
                              </div>
                              <div class="mdc-switch__icons"><svg viewBox="0 0 24 24" aria-hidden="true"
                        ...
                        </button><label class="mdc-label" for="mat-mdc-slide-toggle-1-button"
                          id="mat-mdc-slide-toggle-1-label"> I confirm I am happy for NEBOSH to store and use my
                          details, as detailed above <strong _ngcontent-ng-c3871411255="">tick box, must be ticked to
                            proceed</strong></label></div>
                    </mat-slide-toggle>
                  </div>
                  <div _ngcontent-ng-c3871411255="" class="nav-container">
                    <div _ngcontent-ng-c3871411255=""></div>
                    <div _ngcontent-ng-c3871411255="" style="flex-grow: 1;"></div><button _ngcontent-ng-c3871411255=""
                      mat-button="" matsteppernext="" type="submit"
                      class="mat-stepper-next mdc-button mat-mdc-button mat-mdc-button-disabled mat-unthemed mat-mdc-button-base"
                      mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple"
                      mat-ripple-loader-disabled="" disabled="true"><span
                        class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span
                        class="mdc-button__label"> Next </span><span class="mat-mdc-focus-indicator"></span><span
            ...
            <div role="tabpanel"
              class="mat-horizontal-stepper-content mat-horizontal-stepper-content-inactive ng-trigger ng-trigger-horizontalStepTransition"
              id="cdk-step-content-0-1" aria-labelledby="cdk-step-label-0-1"
              style="transform: translate3d(100%, 0px, 0px); visibility: hidden;">
              <form _ngcontent-ng-c3871411255="" novalidate="" class="ng-untouched ng-pristine ng-invalid">
                <div _ngcontent-ng-c3871411255="" class="fields-container">
                  <h3 _ngcontent-ng-c3871411255="" class="text-center">Your Details</h3>
                  <div _ngcontent-ng-c3871411255="" class="field-container">
                    <mat-form-field _ngcontent-ng-c3871411255=""
                      class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-form-field-appearance-fill mat-form-field-hide-placeholder mat-primary ng-untouched ng-pristine ng-invalid ng-tns-c3736059725-1">
                      <!---->
                      <div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled">
                        ...
                        <div class="mat-mdc-form-field-flex">
                          ...
                          <!---->
                          <!---->
                          <div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel=""
                              class="mdc-floating-label mat-mdc-floating-label" id="mat-mdc-form-field-label-0"
                              for="mat-input-0">
                              <mat-label _ngcontent-ng-c3871411255="">Your name</mat-label><span aria-hidden="true"
                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span>
                              <!---->
                            </label>
                            <!---->
                            <!---->
                            <!----><input _ngcontent-ng-c3871411255="" matinput="" placeholder="Enter your name..."
                              formcontrolname="yourName" required=""
                              class="mat-mdc-input-element mat-mdc-form-field-input-control mdc-text-field__input ng-untouched ng-pristine ng-invalid cdk-text-field-autofill-monitored"
                              id="mat-input-0" aria-required="true">
                          </div>
                          <!---->
                          <!---->
                        </div>
                      ...
                      <div class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align">
                        <div class="mat-mdc-form-field-hint-wrapper ng-trigger ng-trigger-transitionMessages"
                  ...
                  <div _ngcontent-ng-c3871411255="" class="field-container">
                    <mat-form-field _ngcontent-ng-c3871411255=""
                      class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-form-field-appearance-fill mat-form-field-hide-placeholder mat-primary ng-untouched ng-pristine ng-invalid ng-tns-c3736059725-2">
                      <!---->
                      <div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled">
                        <div class="mat-mdc-form-field-focus-overlay"></div>
                        <!---->
                        <div class="mat-mdc-form-field-flex">
                          ...
                          <!---->
                          <div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel=""
                              class="mdc-floating-label mat-mdc-floating-label" id="mat-mdc-form-field-label-2"
                              for="mat-input-1">
                              <mat-label _ngcontent-ng-c3871411255="">Your Organisation</mat-label><span
                                aria-hidden="true"
                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span>
                              <!---->
                            </label>
                            <!---->
                            <!---->
                            <!----><input _ngcontent-ng-c3871411255="" matinput=""
                              placeholder="Enter your Organsiation's name..." formcontrolname="yourOrganisation"
                              required=""
                              class="mat-mdc-input-element mat-mdc-form-field-input-control mdc-text-field__input ng-untouched ng-pristine ng-invalid cdk-text-field-autofill-monitored"
                              id="mat-input-1" aria-required="true">
                          </div>
                          <!---->
                          <!---->
                        </div>
                  ...
                  <div _ngcontent-ng-c3871411255="" class="field-container">
                    <mat-form-field _ngcontent-ng-c3871411255=""
                      class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-form-field-appearance-fill mat-form-field-hide-placeholder mat-primary ng-untouched ng-pristine ng-invalid ng-tns-c3736059725-3">
                      <!---->
                      <div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled">
                        <div class="mat-mdc-form-field-focus-overlay"></div>
                        <!---->
                        <div class="mat-mdc-form-field-flex">
                          ...
                          <!---->
                          <div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel=""
                              class="mdc-floating-label mat-mdc-floating-label" id="mat-mdc-form-field-label-4"
                              for="mat-input-2">
                              <mat-label _ngcontent-ng-c3871411255="">Your Email</mat-label><span aria-hidden="true"
                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span>
                              <!---->
                            </label>
                            <!---->
                            <!---->
                            <!----><input _ngcontent-ng-c3871411255="" matinput="" placeholder="Enter your email..."
                              formcontrolname="yourEmail" required=""
                              class="mat-mdc-input-element mat-mdc-form-field-input-control mdc-text-field__input ng-untouched ng-pristine ng-invalid cdk-text-field-autofill-monitored"
                              id="mat-input-2" aria-required="true">
                          </div>
                          <!---->
                          <!---->
                        </div>
                  ...
                  <div _ngcontent-ng-c3871411255="" class="nav-container"><button _ngcontent-ng-c3871411255=""
                      mat-button="" matstepperprevious=""
                      class="mat-stepper-previous mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base"
                      mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple"
                      type="button"><span class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span
                        class="mdc-button__label">Back</span><span class="mat-mdc-focus-indicator"></span><span
                        class="mat-mdc-button-touch-target"></span></button>
                    <div _ngcontent-ng-c3871411255="" style="flex-grow: 1;"></div><button _ngcontent-ng-c3871411255=""
                      mat-button="" matsteppernext=""
                      class="mat-stepper-next mdc-button mat-mdc-button mat-mdc-button-disabled mat-unthemed mat-mdc-button-base"
                      mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple"
                      mat-ripple-loader-disabled="" disabled="true" type="submit"><span
                        class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span
                        class="mdc-button__label"> Next </span><span class="mat-mdc-focus-indicator"></span><span
                        class="mat-mdc-button-touch-target"></span></button>
                  </div>
            ...
            <div role="tabpanel"
              class="mat-horizontal-stepper-content mat-horizontal-stepper-content-inactive ng-trigger ng-trigger-horizontalStepTransition"
              id="cdk-step-content-0-2" aria-labelledby="cdk-step-label-0-2"
              style="transform: translate3d(100%, 0px, 0px); visibility: hidden;">
              <form _ngcontent-ng-c3871411255="" novalidate="" class="ng-pristine ng-touched">
                <div _ngcontent-ng-c3871411255="" class="fields-container">
                  <h3 _ngcontent-ng-c3871411255="" class="text-center"> To verify a certificate or parchment, please
                    enter the following pieces of information exactly as they appear on the document </h3>
                  <div _ngcontent-ng-c3871411255="" class="field-container">
                    <mat-form-field _ngcontent-ng-c3871411255=""
                      class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-form-field-appearance-fill mat-primary ng-pristine ng-tns-c3736059725-4 mat-form-field-disabled ng-touched">
                      <!---->
                      <div
                        class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled mdc-text-field--disabled">
                        <!---->
                        <div class="mat-mdc-form-field-flex">
                          <!---->
                          <!---->
                          ...
                          <div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel=""
                              ...
                              id="mat-mdc-form-field-label-6" for="mat-input-3">
                              <mat-label _ngcontent-ng-c3871411255="">Learner Name</mat-label><span aria-hidden="true"
                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span>
                              <!---->
                            </label>
                            <!---->
                            <!---->
                            <!----><input _ngcontent-ng-c3871411255="" matinput="" placeholder="Enter Learner Name..."
                              formcontrolname="learnerName" required=""
                              class="mat-mdc-input-element mat-mdc-form-field-input-control mdc-text-field__input ng-pristine cdk-text-field-autofill-monitored ng-touched"
                              id="mat-input-3" aria-required="true" disabled="" aria-invalid="false">
                          </div>
                          <!---->
                          <!---->
                        </div>
                  ...
                  <div _ngcontent-ng-c3871411255="" class="field-container">
                    <mat-form-field _ngcontent-ng-c3871411255=""
                      class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-form-field-appearance-fill mat-primary ng-pristine ng-tns-c3736059725-5 mat-form-field-disabled ng-touched">
                      <!---->
                      <div
                        class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled mdc-text-field--disabled">
                        <!---->
                        <div class="mat-mdc-form-field-flex">
                          ...
                          <div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel=""
                              class="mdc-floating-label mat-mdc-floating-label mdc-floating-label--float-above"
                              id="mat-mdc-form-field-label-8" for="mat-input-4">
                              <mat-label _ngcontent-ng-c3871411255="">Certificate Master Log Number</mat-label><span
                                aria-hidden="true"
                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span>
                              <!---->
                            </label>
                            ...
                            <!---->
                            <!----><input _ngcontent-ng-c3871411255="" matinput=""
                              placeholder="Enter Master Log Number..." formcontrolname="logNumber" required=""
                              class="mat-mdc-input-element mat-mdc-form-field-input-control mdc-text-field__input ng-pristine cdk-text-field-autofill-monitored ng-touched"
                              id="mat-input-4" aria-required="true" disabled="" aria-invalid="false">
                          </div>
                          <!---->
                          <!---->
                        </div>
                  ...
                  <div _ngcontent-ng-c3871411255="" class="field-container">
                    <mat-form-field _ngcontent-ng-c3871411255=""
                      class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-mdc-form-field-has-icon-suffix mat-form-field-appearance-fill mat-primary ng-pristine ng-tns-c3736059725-6 mat-form-field-disabled ng-touched">
                      <!---->
                      <div
                        class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled mdc-text-field--disabled">
                        <!---->
                        <div class="mat-mdc-form-field-flex">
                          ...
                          <div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel=""
                              class="mdc-floating-label mat-mdc-floating-label mdc-floating-label--float-above"
                              id="mat-mdc-form-field-label-10" for="mat-input-5">
                              <mat-label _ngcontent-ng-c3871411255="">Date of achievement</mat-label><span
                                aria-hidden="true"
                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span>
                              <!---->
                            </label>
                            <!---->
                            <!---->
                            <!----><input _ngcontent-ng-c3871411255="" matinput="" formcontrolname="dateOfAchievement"
                              placeholder="Date of achievement..." required=""
                              class="mat-mdc-input-element mat-datepicker-input mat-mdc-form-field-input-control mdc-text-field__input ng-pristine cdk-text-field-autofill-monitored ng-touched"
                              aria-describedby="mat-mdc-hint-0" id="mat-input-5" aria-required="true"
                              aria-haspopup="dialog" data-mat-calendar="mat-datepicker-0" disabled=""
                              aria-invalid="false">
                            <mat-datepicker _ngcontent-ng-c3871411255=""></mat-datepicker>
                            <!---->
                          </div>
                          <!---->
                          <div class="mat-mdc-form-field-icon-suffix">
                            <mat-datepicker-toggle _ngcontent-ng-c3871411255="" maticonsuffix=""
                              class="mat-datepicker-toggle" data-mat-calendar="mat-datepicker-0"><button
                                mat-icon-button="" type="button" mat-ripple-loader-uninitialized=""
                                mat-ripple-loader-class-name="mat-mdc-button-ripple"
                                class="mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base mat-mdc-button-disabled"
                                mat-ripple-loader-centered="" aria-haspopup="dialog" aria-label="Open calendar"
                                tabindex="-1" mat-ripple-loader-disabled="" disabled="true"><span
                                  ...
                                  aria-hidden="true" class="mat-datepicker-toggle-default-icon">
                                  <path
                      ...
                      <div class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align">
                        <div class="mat-mdc-form-field-hint-wrapper ng-trigger ng-trigger-transitionMessages"
                          style="opacity: 1; transform: translateY(0%);">
                          <!---->
                          <mat-hint _ngcontent-ng-c3871411255=""
                            class="mat-mdc-form-field-hint mat-mdc-form-field-bottom-align" id="mat-mdc-hint-0">
                            dd/mm/yyyy</mat-hint>
                          <div class="mat-mdc-form-field-hint-spacer"></div>
                        </div>
                        <!---->
                  ...
                  <div _ngcontent-ng-c3871411255="" class="nav-container"><button _ngcontent-ng-c3871411255=""
                    ...
                    <div _ngcontent-ng-c3871411255="" style="flex-grow: 1;"></div><button _ngcontent-ng-c3871411255=""
                      mat-button="" matsteppernext=""
                      class="mat-stepper-next mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base"
                      mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple"
                      type="submit"><span class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span
                        class="mdc-button__label"> Send Request </span><span
            ...
            <div role="tabpanel"
              class="mat-horizontal-stepper-content mat-horizontal-stepper-content-inactive ng-trigger ng-trigger-horizontalStepTransition"
              id="cdk-step-content-0-3" aria-labelledby="cdk-step-label-0-3"
              style="transform: translate3d(100%, 0px, 0px); visibility: hidden;">
              <div _ngcontent-ng-c3871411255="" class="results-container">
                <h3 _ngcontent-ng-c3871411255="" class="text-center"> Thank you for your request to verify a NEBOSH
                  certificate. Your request has been sent to the learner that was issued this certificate for
                  authentication. </h3>
                <div _ngcontent-ng-c3871411255="" class="result-text"> Verification of this document is <strong
                    _ngcontent-ng-c3871411255="" style="text-decoration: underline;">not</strong> complete until you
                  have received formal verification by email, <strong _ngcontent-ng-c3871411255="">from NEBOSH</strong>
                </div>
                <div _ngcontent-ng-c3871411255="" class="result-text"> An email will be sent to you within 2 working
                  days confirming the outcome of your request. </div>
                <div _ngcontent-ng-c3871411255="" class="result-text"> Full information of our <a
                    _ngcontent-ng-c3871411255=""
                    href="https://www.nebosh.org.uk/policies-and-procedures/verifications/">verification process and
                    additional guidance</a> on how to verify certificates is available on the <a
                    _ngcontent-ng-c3871411255="" href="https://www.nebosh.org.uk/home/">NEBOSH website</a>. </div>
              </div>
              <!---->
              <!---->
            </div>
  ...
  <script src="main-VVQOJLAQ.js" type="module"></script>
  ...
  {{-- <div id="protected-content" class="hidden-content">
    ...
    <p>This content is displayed after passing the reCAPTCHA verification.</p>
  </div> --}}
  ...
  function onRecaptchaSuccess() {
      ...
      // get element by class name mat-horizontal-stepper-wrapper
      document.getElementsByClassName('mat-horizontal-stepper-wrapper')[0].style.display = 'block';
      document.getElementsByClassName('mat-horizontal-stepper-wrapper')[1].style.display = 'block';
