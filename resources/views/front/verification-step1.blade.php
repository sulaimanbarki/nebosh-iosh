...
<head>
    ...
    <link rel="stylesheet" href="styles-32CNHAWB.css" media="all" onload="this.media='all'"><noscript>
        <link rel="stylesheet" href="styles-32CNHAWB.css">
    </noscript>
    <link rel="modulepreload" href="chunk-XXV7Z4K4.js">
    <style type="text/css"></style>
    <style>
        h3[_ngcontent-ng-c3366146534],
        h4[_ngcontent-ng-c3366146534],
        h5[_ngcontent-ng-c3366146534] {
            text-align: center;
            max-width: 500px;
            width: 100%
        }

        .fields-container[_ngcontent-ng-c3366146534] {
            width: 100%;
            display: flex;
            align-items: center;
        ...
        .field-container[_ngcontent-ng-c3366146534],
        .standard[_ngcontent-ng-c3366146534] {
            max-width: 500px;
            width: 100%
        }

        .nav-container[_ngcontent-ng-c3366146534] {
            max-width: 500px;
            width: 100%;
            display: flex;
            margin-top: 40px
...
<body class="mat-typography" data-new-gr-c-s-check-loaded="14.1209.0" data-gr-ext-installed=""
    cz-shortcut-listen="true">
    <app-root _nghost-ng-c3885976823="" ng-version="17.3.5">
        <div _ngcontent-ng-c3885976823="" style="width: 100%; display: flex; justify-content: center; flex-wrap: wrap;">
            <img _ngcontent-ng-c3885976823="" src="assets/NeboshLogo.jpg" style="width: 250px;">
        </div><router-outlet _ngcontent-ng-c3885976823=""></router-outlet><app-details
            _nghost-ng-c3366146534=""><mat-stepper _ngcontent-ng-c3366146534="" role="tablist"
                aria-orientation="horizontal"
                class="mat-stepper-horizontal mat-stepper-label-position-end ng-tns-c3820311392-0"><!---->
                <div class="mat-horizontal-stepper-wrapper">
                    <div class="mat-horizontal-stepper-header-container"><mat-step-header role="tab"
                            class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="0"
                            id="cdk-step-label-0-0" aria-posinset="1" aria-setsize="4"
                            ...
                            <div class="mat-step-icon mat-step-icon-state-number mat-step-icon-selected">
                                <div class="mat-step-icon-content"><span
                        ...
                        <div class="mat-stepper-horizontal-line"></div><!----><mat-step-header role="tab"
                            class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="-1"
                            id="cdk-step-label-0-1" aria-posinset="2" aria-setsize="4"
                            aria-controls="cdk-step-content-0-1" aria-selected="false" aria-disabled="true">
                            <div matripple="" class="mat-ripple mat-step-header-ripple mat-focus-indicator"></div>
                        ...
                        <div class="mat-stepper-horizontal-line"></div><!----><mat-step-header role="tab"
                            class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="-1"
                            id="cdk-step-label-0-2" aria-posinset="3" aria-setsize="4"
                            aria-controls="cdk-step-content-0-2" aria-selected="false" aria-disabled="true">
                            <div matripple="" class="mat-ripple mat-step-header-ripple mat-focus-indicator"></div>
                            <div class="mat-step-icon mat-step-icon-state-number">
                                <div class="mat-step-icon-content"><span
                        ...
                        <div class="mat-stepper-horizontal-line"></div><!----><mat-step-header role="tab"
                            class="mat-step-header mat-horizontal-stepper-header mat-primary" tabindex="-1"
                            id="cdk-step-label-0-3" aria-posinset="4" aria-setsize="4"
                            aria-controls="cdk-step-content-0-3" aria-selected="false" aria-disabled="true">
                            <div matripple="" class="mat-ripple mat-step-header-ripple mat-focus-indicator"></div>
                            <div class="mat-step-icon mat-step-icon-state-number">
                                <div class="mat-step-icon-content"><span
                    ...
                    <div class="mat-horizontal-content-container">
                        <div role="tabpanel"
                            class="mat-horizontal-stepper-content ng-trigger ng-trigger-horizontalStepTransition"
                            id="cdk-step-content-0-0" aria-labelledby="cdk-step-label-0-0"
                            style="transform: none; visibility: inherit;">
                            <form _ngcontent-ng-c3366146534="" novalidate=""
                                class="ng-untouched ng-pristine ng-invalid">
                                <div _ngcontent-ng-c3366146534="" class="fields-container">
                                    <h3 _ngcontent-ng-c3366146534="">IMPORTANT, PLEASE READ BEFORE CONTINUING</h3>
                                    <h5 _ngcontent-ng-c3366146534="" style="text-align: left;"> NEBOSH takes the
                                        security of personal data and NEBOSH certificates extremely seriously. As part
                                        of the verification process, NEBOSH will email the learner that was originally
                                        issued this certificate to authenticate your request. </h5>
                                    <h5 _ngcontent-ng-c3366146534="" style="text-align: left;"> To allow the learner
                                        to identify who is requesting information relating to them, your name and
                                        organisation will be provided to the learner to allow them to authorise your
                                        request. </h5>
                                    <h5 _ngcontent-ng-c3366146534="" style="text-align: left;"> Your email address
                                        will be used by NEBOSH to confirm the outcome of your request within 2 working
                                        days of submission. </h5>
                                    <h5 _ngcontent-ng-c3366146534="" style="text-align: left;"><strong
                                            _ngcontent-ng-c3366146534="">Please note: </strong>The outcome of this
                                        request will be recorded and held by NEBOSH for monitoring purposes. This
                                        includes your name, organisation and email address. Please tick the box below to
                                        confirm your acceptance or contact NEBOSH </h5>
                                    <div _ngcontent-ng-c3366146534="" class="field-container"><mat-slide-toggle
                                            _ngcontent-ng-c3366146534="" formcontrolname="acceptTerms"
                                            class="mat-mdc-slide-toggle mat-accent ng-untouched ng-pristine ng-invalid"
                                            id="mat-mdc-slide-toggle-1">
                                            <div mat-internal-form-field=""
                                                class="mdc-form-field mat-internal-form-field"><button role="switch"
                                                    type="button" class="mdc-switch mdc-switch--unselected"
                                                    tabindex="0" id="mat-mdc-slide-toggle-1-button"
                                                    aria-labelledby="mat-mdc-slide-toggle-1-label"
                                                    aria-checked="false">
                                                    ...
                                                    <div class="mdc-switch__handle-track">
                                                        <div class="mdc-switch__handle">
                                                            ...
                                                            <div class="mdc-switch__ripple">
                                                                <div mat-ripple=""
                                                                    class="mat-ripple mat-mdc-slide-toggle-ripple mat-mdc-focus-indicator">
                                                                </div>
                                                            </div>
                                                            <div class="mdc-switch__icons"><svg viewBox="0 0 24 24"
                                                                    aria-hidden="true"
                                                    ...
                                                    id="mat-mdc-slide-toggle-1-label">I confirm I am happy for NEBOSH
                                                    to store and use my details, as detailed above <strong
                                                        _ngcontent-ng-c3366146534="">tick box, must be ticked to
                                                        proceed</strong></label></div>
                                        </mat-slide-toggle></div>
                                    <div _ngcontent-ng-c3366146534="" class="nav-container">
                                        <div _ngcontent-ng-c3366146534=""></div>
                                        <div _ngcontent-ng-c3366146534="" style="flex-grow: 1;"></div>
                                        <div _ngcontent-ng-c3366146534=""><button _ngcontent-ng-c3366146534=""
                                                ...
                                                mat-ripple-loader-disabled="" disabled="true" type="submit"><span
                                                    ...
                                                    class="mdc-button__label">Next</span><span
                        ...
                        <div role="tabpanel"
                            ...
                            <form _ngcontent-ng-c3366146534="" novalidate=""
                                class="ng-untouched ng-pristine ng-invalid">
                                <div _ngcontent-ng-c3366146534="" class="fields-container">
                                    <h3 _ngcontent-ng-c3366146534="">Your Details</h3>
                                    <div _ngcontent-ng-c3366146534="" class="field-container"><mat-form-field
                                            _ngcontent-ng-c3366146534=""
                                            ...
                                            <div
                                                class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled">
                                                ...
                                                <div class="mat-mdc-form-field-flex"><!----><!----><!---->
                                                    <div class="mat-mdc-form-field-infix"><label
                                                            ...
                                                            for="mat-input-0"><mat-label
                                                                _ngcontent-ng-c3366146534="">Your name</mat-label><span
                                                                aria-hidden="true"
                                                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span><!----></label><!----><!----><!----><input
                                                            _ngcontent-ng-c3366146534="" matinput=""
                                                            placeholder="Enter your name..."
                                                            formcontrolname="verifierName"
                                                            class="mat-mdc-input-element ng-untouched ng-pristine ng-invalid mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored"
                                                            id="mat-input-0" required="" aria-required="true">
                                                    </div><!----><!---->
                                                </div>
                                                <div matformfieldlineripple=""
                                                    class="mdc-line-ripple mdc-line-ripple--deactivating"></div><!---->
                                            </div>
                                            <div
                                            ...
                                            <div
                                                ...
                                                <div class="mat-mdc-form-field-flex"><!----><!----><!---->
                                                    <div class="mat-mdc-form-field-infix"><label
                                                            ...
                                                            for="mat-input-1"><mat-label
                                                                _ngcontent-ng-c3366146534="">Your
                                                                Organisation</mat-label><span aria-hidden="true"
                                                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span><!----></label><!----><!----><!----><input
                                                            _ngcontent-ng-c3366146534="" matinput=""
                                                            placeholder="Enter your Organsiation's name..."
                                                            formcontrolname="verifierOrganisation"
                                                            class="mat-mdc-input-element ng-untouched ng-pristine ng-invalid mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored"
                                                            id="mat-input-1" required="" aria-required="true">
                                                    </div><!----><!---->
                                                </div>
                                                <div matformfieldlineripple=""
                                                    class="mdc-line-ripple mdc-line-ripple--deactivating"></div><!---->
                                            ...
                                            <div
                                                ...
                                                <div class="mat-mdc-form-field-flex"><!----><!----><!---->
                                                    <div class="mat-mdc-form-field-infix"><label
                                                            ...
                                                            for="mat-input-2"><mat-label
                                                                _ngcontent-ng-c3366146534="">Your
                                                                Email</mat-label><span aria-hidden="true"
                                                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span><!----></label><!----><!----><!----><input
                                                            _ngcontent-ng-c3366146534="" matinput=""
                                                            placeholder="Enter your email address..."
                                                            formcontrolname="verifierEmail"
                                                            class="mat-mdc-input-element ng-untouched ng-pristine ng-invalid mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored"
                                                            id="mat-input-2" required="" aria-required="true">
                                                    </div><!----><!---->
                                                </div>
                                                <div matformfieldlineripple=""
                                                    class="mdc-line-ripple mdc-line-ripple--deactivating"></div><!---->
                                    ...
                                    <div _ngcontent-ng-c3366146534="" class="nav-container">
                                        <div _ngcontent-ng-c3366146534=""><button _ngcontent-ng-c3366146534=""
                                                ...
                                                type="button"><span
                                                    class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span
                                                    class="mdc-button__label">Back</span><span
                                                    class="mat-mdc-focus-indicator"></span><span
                                                    class="mat-mdc-button-touch-target"></span></button></div>
                                        <div _ngcontent-ng-c3366146534="" style="flex-grow: 1;"></div>
                                        <div _ngcontent-ng-c3366146534=""><button _ngcontent-ng-c3366146534=""
                        ...
                        <div role="tabpanel"
                            ...
                            style="transform: translate3d(100%, 0px, 0px); visibility: hidden;">
                            <form _ngcontent-ng-c3366146534="" novalidate="" class="ng-untouched ng-pristine">
                                <div _ngcontent-ng-c3366146534="" class="fields-container">
                                    <h3 _ngcontent-ng-c3366146534="">To verify a certificate or parchment, please enter
                                        the following pieces of information exactly as they appear on the document</h3>
                                    <div _ngcontent-ng-c3366146534="" class="field-container"><mat-form-field
                                            _ngcontent-ng-c3366146534=""
                                            class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-form-field-disabled mat-form-field-appearance-fill mat-primary ng-untouched ng-pristine ng-tns-c3736059725-4"><!---->
                                            <div
                                                ...
                                                <div class="mat-mdc-form-field-flex"><!----><!----><!---->
                                                    <div class="mat-mdc-form-field-infix"><label
                                                            ...
                                                            for="mat-input-3"><mat-label
                                                                _ngcontent-ng-c3366146534="">Learner
                                                                Name</mat-label><span aria-hidden="true"
                                                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span><!----></label><!----><!----><!----><input
                                                            _ngcontent-ng-c3366146534="" matinput=""
                                                            placeholder="Enter Learner Name..."
                                                            formcontrolname="learnerName" readonly="true"
                                                            class="mat-mdc-input-element ng-untouched ng-pristine mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored"
                                                            disabled="" id="mat-input-3" required=""
                                    ...
                                    <div _ngcontent-ng-c3366146534="" class="field-container"><mat-form-field
                                            _ngcontent-ng-c3366146534=""
                                            class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-form-field-disabled mat-form-field-appearance-fill mat-primary ng-untouched ng-pristine ng-tns-c3736059725-5"><!---->
                                            <div
                                                class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled mdc-text-field--disabled">
                                                <!---->
                                                <div class="mat-mdc-form-field-flex"><!----><!----><!---->
                                                    <div class="mat-mdc-form-field-infix"><label
                                                            matformfieldfloatinglabel=""
                                                            class="mdc-floating-label mat-mdc-floating-label mdc-floating-label--float-above"
                                                            id="mat-mdc-form-field-label-8"
                                                            for="mat-input-4"><mat-label
                                                                _ngcontent-ng-c3366146534="">Certificate Master Log
                                                                Number</mat-label><span aria-hidden="true"
                                                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span><!----></label><!----><!----><!----><input
                                                            _ngcontent-ng-c3366146534="" matinput=""
                                                            placeholder="Enter Master Log Number..."
                                                            formcontrolname="certMasterLog" readonly="true"
                                                            class="mat-mdc-input-element ng-untouched ng-pristine mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored"
                                                            disabled="" id="mat-input-4" required=""
                                                            aria-required="true" aria-invalid="false"></div>
                                                    <!----><!---->
                                                </div>
                                                <div matformfieldlineripple=""
                                    ...
                                    <div _ngcontent-ng-c3366146534="" class="field-container"><mat-form-field
                                            _ngcontent-ng-c3366146534=""
                                            class="mat-mdc-form-field full-width mat-mdc-form-field-type-mat-input mat-mdc-form-field-has-icon-suffix mat-form-field-disabled mat-form-field-appearance-fill mat-primary ng-untouched ng-pristine ng-tns-c3736059725-6"><!---->
                                            <div
                                                class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled mdc-text-field--disabled">
                                                <!---->
                                                <div class="mat-mdc-form-field-flex"><!----><!----><!---->
                                                    <div class="mat-mdc-form-field-infix"><label
                                                            matformfieldfloatinglabel=""
                                                            class="mdc-floating-label mat-mdc-floating-label mdc-floating-label--float-above"
                                                            id="mat-mdc-form-field-label-10"
                                                            for="mat-input-5"><mat-label
                                                                _ngcontent-ng-c3366146534="">Date of
                                                                achievement</mat-label><span aria-hidden="true"
                                                                class="mat-mdc-form-field-required-marker mdc-floating-label--required"></span><!----></label><!----><!----><!----><input
                                                            _ngcontent-ng-c3366146534="" matinput=""
                                                            placeholder="Date of achievement..."
                                                            formcontrolname="certDate" readonly="true"
                                                            class="mat-datepicker-input mat-mdc-input-element ng-untouched ng-pristine mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored"
                                                            aria-describedby="mat-mdc-hint-0" disabled=""
                                                            aria-haspopup="dialog"
                                                            data-mat-calendar="mat-datepicker-0" id="mat-input-5"
                                                            required="" aria-invalid="false"
                                                            aria-required="true"><mat-datepicker
                                                            _ngcontent-ng-c3366146534=""></mat-datepicker><!----></div>
                                                    <!---->
                                                    <div class="mat-mdc-form-field-icon-suffix"><mat-datepicker-toggle
                                                            _ngcontent-ng-c3366146534="" maticonsuffix=""
                                                            class="mat-datepicker-toggle"
                                                            data-mat-calendar="mat-datepicker-0"><button
                                                                mat-icon-button="" type="button"
                                                                mat-ripple-loader-uninitialized=""
                                                                mat-ripple-loader-class-name="mat-mdc-button-ripple"
                                                                class="mdc-icon-button mat-mdc-icon-button mat-mdc-button-disabled mat-unthemed mat-mdc-button-base"
                                                                mat-ripple-loader-centered=""
                                                                mat-ripple-loader-disabled="" aria-haspopup="dialog"
                                            ...
                                            <div
                                                class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align">
                                                <div class="mat-mdc-form-field-hint-wrapper ng-trigger ng-trigger-transitionMessages"
                                                    style="opacity: 1; transform: translateY(0%);"><!----><mat-hint
                                                        _ngcontent-ng-c3366146534=""
                                                        class="mat-mdc-form-field-hint mat-mdc-form-field-bottom-align"
                                                        id="mat-mdc-hint-0">dd/mm/yyyy</mat-hint>
                                                    <div class="mat-mdc-form-field-hint-spacer"></div>
                                                </div><!----><!---->
                                            </div>
                                        </mat-form-field></div><!---->
                                    <div _ngcontent-ng-c3366146534="" class="nav-container">
                                        ...
                                        <div _ngcontent-ng-c3366146534="" style="flex-grow: 1;"></div>
                                        <div _ngcontent-ng-c3366146534=""><button _ngcontent-ng-c3366146534=""
                                                mat-button="" mat-ripple-loader-uninitialized=""
                                                mat-ripple-loader-class-name="mat-mdc-button-ripple"
                                                class="mdc-button mat-mdc-button mat-mdc-button-disabled mat-unthemed mat-mdc-button-base"
                        ...
                        <div role="tabpanel"
                            ...
                            style="transform: translate3d(100%, 0px, 0px); visibility: hidden;">
                            <div _ngcontent-ng-c3366146534="" class="results-container">
                                <h3 _ngcontent-ng-c3366146534=""> Thank you for your request to verify a NEBOSH
                                    certificate. Your request has been sent to the learner that was issued this
                                    certificate for authentication. </h3>
                                <div _ngcontent-ng-c3366146534="" class="result-text"> Verification of this document
                                    is <strong _ngcontent-ng-c3366146534=""
                                        style="text-decoration: underline;">not</strong> complete until you have
                                    received formal verification by email, <strong _ngcontent-ng-c3366146534="">from
                                        NEBOSH</strong></div>
                                <div _ngcontent-ng-c3366146534="" class="result-text"> An email will be sent to you
                                    within 2 working days confirming the outcome of your request. </div>
                                <div _ngcontent-ng-c3366146534="" class="result-text"> Full information of our <a
                                        _ngcontent-ng-c3366146534=""
                                        href="https://www.nebosh.org.uk/policies-and-procedures/verifications/">verification
                                        process and additional guidance</a> on how to verify certificates is available
                                    on the <a _ngcontent-ng-c3366146534=""
                                        href="https://www.nebosh.org.uk/home/">NEBOSH website</a>. </div>
                            </div><!----><!---->
                        </div><!---->
                    </div>
                </div><!----><!----><!---->
            </mat-stepper><!----></app-details><!---->
    </app-root>
    <script></script>
