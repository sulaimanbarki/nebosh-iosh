import {Ac as pt, Bc as Ne, Hc as x, Ic as Me, Jc as he, T as S, V as mt, a as le, c as dt, vc as E, wc as B} from "./chunk-O2QDAK4C.js";
function gt(n) {
    return new S(3e3,!1)
}
function Wt() {
...
function Ce(n, e, t) {
    let s = t.totalTime
      , i = !!t.disabled
      , r = tt(n.element, n.triggerName, n.fromState, n.toState, e || n.phaseName, s ?? n.totalTime, i)
      , a = n._data;
...
function Ms(n) {
    H || (H = Cs() || {},
    _t = H.style ? "WebkitAppearance"in H.style : !1);
    let e = !0;
    return H.style && !Ns(n) && (e = n in H.style,
    !e && _t && (e = "Webkit" + n.charAt(0).toUpperCase() + n.slice(1)in H.style)),
    e
}
function wi(n) {
    return As.has(n)
...
var zt = ( () => {
    class n {
        ...
        static{this.\u0275fac = function(s) {
            return new (s || n)
        }
        }static{this.\u0275prov = mt({
            token: n,
            factory: n.\u0275fac
        })
        }
...
function qs(n, e) {
    let t = [];
    return typeof n == "string" ? n.split(/\s*,\s*/).forEach(s => Bs(s, t, e)) : t.push(n),
    t
}
function Bs(n, e, t) {
    if (n[0] == ":") {
...
function vt(n, e) {
    ...
    return (i, r) => {
        let a = n == _e || n == i
          , o = e == _e || e == r;
        return !a && t && typeof i == "boolean" && (a = i ? ce.has(n) : fe.has(n)),
  ...
  , Qe = class {
    ...
    visitTrigger(e, t) {
        let s = t.queryCount = 0
          ...
          , r = []
          , a = [];
        return e.name.charAt(0) == "@" && t.errors.push(Jt()),
    ...
    _makeStyleAst(e, t) {
        ...
        for (let o of i)
            typeof o == "string" ? o === B ? s.push(o) : t.errors.push(ts(o)) : s.push(new Map(Object.entries(o)));
        let r = !1
          , a = null;
        return s.forEach(o => {
        ...
        e.styles.forEach(a => {
            typeof a != "string" && a.forEach( (o, l) => {
                let h = t.collectedStyles.get(t.currentQuerySelector)
                  , c = h.get(l)
                  , u = !0;
                c && (r != i && r >= c.startTime && i <= c.endTime && (t.errors.push(ss(l, c.startTime, c.endTime, r, i)),
                u = !1),
                r = c.startTime),
                u && h.set(l, {
                    startTime: r,
...
function Vs(n) {
    ...
    n = n.replace(/@\*/g, ge).replace(/@\w+/g, t => ge + "-" + t.slice(1)).replace(/:animating/g, ze),
    [n, e]
}
function Us(n) {
    return n ? le({}, n) : null
...
function Y(n) {
    return n ? (n = le({}, n),
    n.params && (n.params = Us(n.params))) : n = {},
    n
}
function ke(n, e, t) {
    return {
...
var Ve = class {
    ...
    visitSequence(e, t) {
        ...
        r.delay != null)) {
            i.previousNode.type == E.Style && (i.currentTimeline.snapshotCurrentStyles(),
            i.previousNode = Se);
            let a = $(r.delay);
            i.delayNextStep(a)
        }
    ...
    visitAnimate(e, t) {
        ...
        let r = e.style;
        r.type == E.Keyframes ? this.visitKeyframes(r, t) : (t.incrementTime(s.duration),
        this.visitStyle(r, t),
    ...
    visitQuery(e, t) {
        let s = t.currentTimeline.currentTime
          , i = e.options || {}
          , r = i.delay ? $(i.delay) : 0;
        r && (t.previousNode.type === E.Style || s == 0 && t.currentTimeline.hasCurrentStyleProperties()) && (t.currentTimeline.snapshotCurrentStyles(),
        t.previousNode = Se);
        let a = s
  ...
  , Ue = class n {
    ...
    invokeQuery(e, t, s, i, r, a) {
        ...
        return !r && o.length == 0 && a.push(ls(t)),
        o
    }
}
  , Ee = class n {
  ...
  , Te = class {
    ...
    build(e, t, s, i, r, a, o, l, h, c) {
        ...
        u.length ? At(t, this._triggerName, s, i, N, d, v, [], [], A, C, k, u) : (K.forEach(D => {
            ...
            D.postStyleProps.forEach(W => ht.add(W)),
            j !== t && b.add(j)
        }
        ),
...
var si = new te
  , He = class {
    ...
    create(e, t, s={}) {
        ...
        if (r ? (a = lt(this._driver, t, r, it, pe, new Map, new Map, s, si, i),
        a.forEach(c => {
  ...
  , Ye = class {
    ...
    removeNode(e, t) {
        ...
        i)
            ...
            let r = e[z];
            (!r || r === $t) && (s.afterFlush( () => this.clearElementCache(e)),
        ...
        return this._queue.forEach(s => {
            ...
            a && a.forEach(o => {
                if (o.name == s.triggerName) {
                    ...
                    l._data = e,
                    et(s.player, o.phase, l, o.callback)
                }
            }
            ),
  ...
  , Xe = class {
    ...
    markElementAsDisabled(e, t) {
        ...
        I(e, Re)) : this.disabledNodes.has(e) && (this.disabledNodes.delete(e),
        ee(e, Re))
    }
    removeNode(e, t, s) {
        if (de(t)) {
    ...
    destroyInnerAnimations(e) {
        ...
        this.playersByQueriedElement.size != 0 && (t = this.driver.query(e, ze, !0),
    ...
    _flushAnimations(e, t) {
        ...
        for (let f = 0; f < this.collectedLeaveElements.length; f++) {
            ...
            b.add(m),
            p.hasAnimation ? this.driver.query(m, ai, !0).forEach(T => b.add(T)) : A.add(m))
        }
        let C = new Map
          , N = kt(_, Array.from(b));
        N.forEach( (f, m) => {
    ...
    _buildAnimation(e, t, s, i, r, a) {
        let o = t.triggerName
          ...
          , _ = t.timelines.map(d => {
            ...
            let b = g !== l
              , A = di((s.get(g) || oi).map(k => k.getRealPlayer())).filter(k => {
                let D = k;
...
function pi(n, e) {
    let t = null
      , s = null;
    return Array.isArray(e) && e.length ? (t = Le(e[0]),
    e.length > 1 && (s = Le(e[e.length - 1]))) : e instanceof Map && (t = Le(e)),
...
;
function Ai(n, e, t) {
    return n === "noop" ? new ve(e,new zt,new Ie,t) : new ve(e,new Je,new Be,t)
}
var Rt = class {
    constructor(e, t) {
        this._driver = e;
  ...
  , xe = class extends be {
    ...
    setProperty(e, t, s) {
        t.charAt(0) == me ? t.charAt(1) == "." && t == Ut ? (s = s === void 0 ? !0 : !!s,
...
;
export {St as AnimationDriver, zt as NoopAnimationDriver, Rt as \u0275Animation, ve as \u0275AnimationEngine, xe as \u0275AnimationRenderer, Ot as \u0275AnimationRendererFactory, Fe as \u0275AnimationStyleNormalizer, be as \u0275BaseAnimationRenderer, Ie as \u0275NoopAnimationStyleNormalizer, Je as \u0275WebAnimationsDriver, we as \u0275WebAnimationsPlayer, Be as \u0275WebAnimationsStyleNormalizer, Is as \u0275allowPreviousPlayerStylesMerge, bi as \u0275camelCaseToDashCase, Ft as \u0275containsElement, Ai as \u0275createEngine, st as \u0275getParentElement, It as \u0275invokeQuery, Os as \u0275normalizeKeyframes, Ms as \u0275validateStyleProperty, wi as \u0275validateWebAnimatableStyleProperty};
