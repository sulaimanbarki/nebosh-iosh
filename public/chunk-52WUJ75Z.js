import {Rc as S, Sc as B, Wc as yt, Xc as Me, Z as E, a as he, aa as gt, bd as x, cd as Ce, d as pt, dd as ue} from "./chunk-XXV7Z4K4.js";
function _t(n) {
    return new E(3e3,!1)
}
function Ht() {
    ...
    if (e.forEach(l => {
        ...
        l.forEach( (_, y) => {
            let d = y
              , g = _;
            if (y !== "offset")
                switch (d = n.normalizePropertyName(d, i),
                g) {
                case ue:
                    g = t.get(y);
                    break;
...
function ke(n, e, t) {
    let s = t.totalTime
      , i = !!t.disabled
      , r = st(n.element, n.triggerName, n.fromState, n.toState, e || n.phaseName, s ?? n.totalTime, i)
      , a = n._data;
    return a != null && (r._data = a),
    r
}
...
function ks(n) {
    H || (H = Ds() || {},
    St = H.style ? "WebkitAppearance"in H.style : !1);
    let e = !0;
    return H.style && !Cs(n) && (e = n in H.style,
    !e && St && (e = "Webkit" + n.charAt(0).toUpperCase() + n.slice(1)in H.style)),
    e
}
function Ai(n) {
    return Ns.has(n)
...
var Bs = new Set(["width", "height", "minWidth", "minHeight", "maxWidth", "maxHeight", "left", "top", "bottom", "right", "fontSize", "outlineWidth", "outlineOffset", "paddingTop", "paddingLeft", "paddingBottom", "paddingRight", "marginTop", "marginLeft", "marginBottom", "marginRight", "borderRadius", "borderWidth", "borderTopWidth", "borderLeftWidth", "borderRightWidth", "borderBottomWidth", "textIndent", "perspective"])
  , Qe = class extends Ie {
    normalizePropertyName(e, t) {
        return rt(e)
    }
...
function Qs(n, e) {
    let t = [];
    return typeof n == "string" ? n.split(/\s*,\s*/).forEach(s => $s(s, t, e)) : t.push(n),
    t
}
function $s(n, e, t) {
    if (n[0] == ":") {
...
function bt(n, e) {
    ...
    return (i, r) => {
        let a = n == Ee || n == i
          , o = e == Ee || e == r;
        return !a && t && typeof i == "boolean" && (a = i ? fe.has(n) : de.has(n)),
  ...
  , $e = class {
    ...
    visitTrigger(e, t) {
        let s = t.queryCount = 0
          ...
          , r = []
          , a = [];
        return e.name.charAt(0) == "@" && t.errors.push(es()),
    ...
    visitStyle(e, t) {
        ...
        return this._validateStyleAst(s, t),
        s
    }
    _makeStyleAst(e, t) {
        let s = []
        ...
        for (let o of i)
            typeof o == "string" ? o === B ? s.push(o) : t.errors.push(is(o)) : s.push(new Map(Object.entries(o)));
        let r = !1
          , a = null;
        return s.forEach(o => {
            if (o instanceof Map && (o.has("easing") && (a = o.get("easing"),
            o.delete("easing")),
            !r)) {
        ...
        e.styles.forEach(a => {
            typeof a != "string" && a.forEach( (o, l) => {
                let h = t.collectedStyles.get(t.currentQuerySelector)
                  , c = h.get(l)
                  , u = !0;
                c && (r != i && r >= c.startTime && i <= c.endTime && (t.errors.push(ns(l, c.startTime, c.endTime, r, i)),
                u = !1),
                r = c.startTime),
                u && h.set(l, {
                    startTime: r,
...
function js(n) {
    ...
    return e && (n = n.replace(Us, "")),
    n = n.replace(/@\*/g, ye).replace(/@\w+/g, t => ye + "-" + t.slice(1)).replace(/:animating/g, Ke),
    [n, e]
}
function Ws(n) {
    return n ? he({}, n) : null
...
function Y(n) {
    return n ? (n = he({}, n),
    n.params && (n.params = Ws(n.params))) : n = {},
    n
}
function De(n, e, t) {
    return {
...
var Ue = class {
    buildKeyframes(e, t, s, i, r, a, o, l, h, c=[]) {
        ...
        return y.length ? y.map(d => d.buildKeyframes()) : [lt(t, [], [], [], 0, _, "", !1)]
    }
    visitTrigger(e, t) {}
    visitState(e, t) {}
    visitTransition(e, t) {}
    ...
    _applyAnimationRefDelays(e, t, s) {
        for (let i of e) {
            let r = i?.delay;
            if (r) {
                let a = typeof r == "number" ? r : $(re(r, i?.params ?? {}, t.errors));
                s.delayNextStep(a)
            }
        }
    }
    ...
    visitSequence(e, t) {
        let s = t.subContextCount
          , i = t
          , r = e.options;
        if (r && (r.params || r.delay) && (i = t.createSubContext(r),
        i.transformIntoNewTimeline(),
        r.delay != null)) {
            i.previousNode.type == S.Style && (i.currentTimeline.snapshotCurrentStyles(),
            i.previousNode = Se);
            let a = $(r.delay);
            i.delayNextStep(a)
        }
        e.steps.length && (e.steps.forEach(a => O(this, a, i)),
    ...
    visitAnimate(e, t) {
        let s = t.currentAnimateTimings = this._visitTiming(e.timings, t)
          , i = t.currentTimeline;
        s.delay && (t.incrementTime(s.delay),
        i.snapshotCurrentStyles());
        let r = e.style;
        r.type == S.Keyframes ? this.visitKeyframes(r, t) : (t.incrementTime(s.duration),
        this.visitStyle(r, t),
    ...
    visitQuery(e, t) {
        let s = t.currentTimeline.currentTime
          , i = e.options || {}
          , r = i.delay ? $(i.delay) : 0;
        r && (t.previousNode.type === S.Style || s == 0 && t.currentTimeline.hasCurrentStyleProperties()) && (t.currentTimeline.snapshotCurrentStyles(),
        t.previousNode = Se);
        let a = s
  ...
  , je = class n {
    ...
    appendInstructionToTimeline(e, t, s) {
        let i = {
          ...
          , r = new We(this._driver,e.element,e.keyframes,e.preStyleProps,e.postStyleProps,i,e.stretchStartingKeyframe);
  ...
  , Te = class n {
    ...
    applyEmptyStep(e) {
        ...
        for (let[t,s] of this._globalTimelineStyles)
            this._backFill.set(t, s || B),
            this._currentKeyframe.set(t, B);
    ...
    setStyles(e, t, s, i) {
        ...
        for (let[o,l] of a) {
            ...
            this._localTimelineStyles.has(o) || this._backFill.set(o, this._globalTimelineStyles.get(o) ?? B),
    ...
    buildKeyframes() {
        ...
        return lt(this.element, i, r, a, this.duration, this.startTime, this.easing, !1)
    }
}
  , We = class extends Te {
    ...
    buildKeyframes() {
        ...
        return lt(this.element, e, this.preStyleProps, this.postStyleProps, s, t, i, !0)
    }
}
;
function Pt(n, e=3) {
...
var Re = {}
  , ve = class {
    ...
    buildStyles(e, t, s) {
        ...
        return e !== void 0 && (i = this._stateStyles.get(e?.toString()) || i),
    ...
    build(e, t, s, i, r, a, o, l, h, c) {
        ...
        u.length ? Nt(t, this._triggerName, s, i, N, d, v, [], [], A, C, k, u) : (K.forEach(D => {
            let j = D.element
              , J = L(A, j, new Set);
        ...
        Nt(t, this._triggerName, s, i, N, d, v, K, [...b.values()], A, C, k))
    }
}
;
...
var ni = new se
  , Ye = class {
    ...
    create(e, t, s={}) {
        ...
        if (r ? (a = ht(this._driver, t, r, nt, ge, new Map, new Map, s, ni, i),
        a.forEach(c => {
        ...
        let l = a.map(c => {
          ...
          , h = U(l);
        return this._playersById.set(e, h),
  ...
  , Xe = class {
    ...
    register(e, t) {
        return this._triggers.has(e) ? !1 : (this._triggers.set(e, t),
        !0)
    }
    _getTrigger(e) {
    ...
    trigger(e, t, s, i=!0) {
        ...
        let l = o.get(t)
          , h = new ae(s,this.id);
        if (!(s && s.hasOwnProperty("value")) && l && h.absorbOptions(l.options),
        o.set(t, h),
        l || (l = Le),
    ...
    removeNode(e, t) {
        ...
        i)
            ...
            let r = e[z];
            (!r || r === Ut) && (s.afterFlush( () => this.clearElementCache(e)),
        ...
        return this._queue.forEach(s => {
            ...
            a && a.forEach(o => {
                if (o.name == s.triggerName) {
                    let l = st(r, s.triggerName, s.fromState.value, s.toState.value);
                    l._data = e,
  ...
  , Ze = class {
    ...
    createNamespace(e, t) {
        ...
        return this.bodyNode && this.driver.containsElement(this.bodyNode, t) ? this._balanceNamespaceList(s, t) : (this.newHostElements.set(t, s),
    ...
    register(e, t) {
        ...
        return s || (s = this.createNamespace(e, t)),
        s
    }
    ...
    markElementAsDisabled(e, t) {
        ...
        I(e, Oe)) : this.disabledNodes.has(e) && (this.disabledNodes.delete(e),
        ee(e, Oe))
    }
    removeNode(e, t, s) {
        if (me(t)) {
    ...
    destroyInnerAnimations(e) {
        ...
        this.playersByQueriedElement.size != 0 && (t = this.driver.query(e, Ke, !0),
    ...
    flush(e=-1) {
        let t = [];
        if (this.newHostElements.size && (this.newHostElements.forEach( (s, i) => this._balanceNamespaceList(s, i)),
    ...
    _flushAnimations(e, t) {
        ...
        for (let f = 0; f < this.collectedLeaveElements.length; f++) {
            let m = this.collectedLeaveElements[f]
              , p = m[z];
            p && p.setForRemoval && (v.push(m),
            b.add(m),
            p.hasAnimation ? this.driver.query(m, li, !0).forEach(T => b.add(T)) : A.add(m))
        }
        let C = new Map
          , N = Rt(_, Array.from(b));
        N.forEach( (f, m) => {
        ...
        a.forEach(f => {
            ...
            if (s.has(m)) {
                ...
                if (p.setRealPlayer(q),
                P === dt)
                    Pe.push(p);
                else {
                    let R = this.playersByElement.get(P);
                    R && R.length && (p.parentPlayer = U(R)),
                    i.push(p)
                }
            } else
                X(m, T.fromStyles),
    ...
    _getPreviousPlayers(e, t, s, i, r) {
        ...
        return (s || i) && (a = a.filter(o => !(s && s != o.namespaceId || i && i != o.triggerName))),
        a
    }
    ...
    _buildAnimation(e, t, s, i, r, a) {
        let o = t.triggerName
          ...
          , _ = t.timelines.map(d => {
            ...
            let b = g !== l
              , A = pi((s.get(g) || hi).map(k => k.getRealPlayer())).filter(k => {
                let D = k;
...
function Dt(n, e, t, s, i) {
    ...
    let o = 0;
    return t.forEach(l => kt(l, r[o++])),
    a
}
function Rt(n, e) {
    let t = new Map;
    if (n.forEach(o => t.set(o, [])),
    e.length == 0)
        return t;
    let s = 1
      , i = new Set(e)
    ...
    function a(o) {
        ...
        if (l)
            return l;
        let h = o.parentNode;
        return t.has(h) ? l = h : i.has(h) ? l = s : l = a(h),
        r.set(o, l),
        l
    }
    return e.forEach(o => {
...
function Ot(n, e, t) {
    ...
    if (!s)
        return !1;
    let i = e.get(n);
    return i ? s.forEach(r => i.add(r)) : e.set(n, s),
    t.delete(n),
    !0
}
var we = class {
    constructor(e, t, s, i) {
        ...
        this._transitionEngine.onRemovalComplete = (r, a) => this.onRemovalComplete(r, a)
    }
...
function yi(n, e) {
    let t = null
      , s = null;
    return Array.isArray(e) && e.length ? (t = Fe(e[0]),
    e.length > 1 && (s = Fe(e[e.length - 1]))) : e instanceof Map && (t = Fe(e)),
...
var te = class te {
    ...
    start() {
        this._state < 1 && (this._startStyles && Q(this._element, this._startStyles, this._initialStyles),
        this._state = 1)
    }
    finish() {
        this.start(),
        this._state < 2 && (Q(this._element, this._initialStyles),
        this._endStyles && (Q(this._element, this._endStyles),
        this._endStyles = null),
        this._state = 1)
    }
    destroy() {
        this.finish(),
        this._state < 3 && (te.initialStylesByElement.delete(this._element),
        this._startStyles && (X(this._element, this._startStyles),
        this._endStyles = null),
        this._endStyles && (X(this._element, this._endStyles),
        this._endStyles = null),
...
;
function Ni(n, e, t) {
    return n === "noop" ? new we(e,new qt,new ze,t) : new we(e,new xe,new Qe,t)
}
var Lt = class {
    constructor(e, t) {
        this._driver = e;
  ...
  , Ae = class {
    ...
    setProperty(e, t, s) {
        t.charAt(0) == pe && t == Wt ? this.disableAnimations(e, !!s) : this.delegate.setProperty(e, t, s)
    }
    setValue(e, t) {
  ...
  , et = class extends Ae {
    ...
    setProperty(e, t, s) {
        t.charAt(0) == pe ? t.charAt(1) == "." && t == Wt ? (s = s === void 0 ? !0 : !!s,
        this.disableAnimations(e, s)) : this.engine.process(this.namespaceId, e, t.slice(1), s) : this.delegate.setProperty(e, t, s)
    }
    listen(e, t, s) {
        if (t.charAt(0) == pe) {
            let i = Ei(e)
...
var Ft = class {
    ...
    createRenderer(e, t) {
        ...
        ;
        return t.data.animation.forEach(o),
        new et(this,a,i,this.engine)
    }
    begin() {
        this._cdRecurDepth++,
