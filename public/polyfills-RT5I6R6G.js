(function(e) {
  ...
  let I = l("setTimeout"), O = l("Promise"), Z = l("then"), B = [], j = !1, J;
  function q(L) {
      if (J || e[O] && (J = e[O].resolve(0)),
      J) {
          let t = J[Z];
          t || (t = J.then),
          t.call(J, L)
...
, Re = !("nw"in Y) && typeof Y.process < "u" && {}.toString.call(Y.process) === "[object process]"
, Ge = !Re && !Je && !!(we && Te.HTMLElement)
, Ke = typeof Y.process < "u" && {}.toString.call(Y.process) === "[object process]" && !Je && !!(we && Te.HTMLElement)
, Pe = {}
, qe = function(e) {
  if (e = e || Y.event,
  !e)
...
function ke(e) {
  ...
  for (r in c)
      e === "XMLHttpRequest" && r === "responseBlob" || function(a) {
          ...
          : Ie(Y[e].prototype, a, {
              set: function(l) {
                  typeof l == "function" ? (this[re][a] = Ae(l, e + "." + a),
                  le(this[re][a], l)) : this[re][a] = l
              },
              get: function() {
                  return this[re][a]
              }
...
function ft(e, n, c) {
  ...
  r = ue(e, n, l => function(y, _) {
      let b = c(y, _);
      return b.cbIdx >= 0 && typeof _[b.cbIdx] == "function" ? He(b.name, _[b.cbIdx], b, a) : l.apply(y, _)
  }
  )
}
function le(e, n) {
...
Zone.__load_patch("ZoneAwarePromise", (e, n, c) => {
  ...
  function z(f, u, i) {
      ...
      if (f[q] === M) {
          ...
          if (u !== x && i instanceof t && i.hasOwnProperty(q) && i.hasOwnProperty(R) && i[q] !== M)
              ne(i),
              z(f, i[q], i[R]);
...
` + i.stack : ""))
  ...
  function ne(f) {
      if (f[q] === d) {
          try {
              let u = n[U];
              u && typeof u == "function" && u.call(this, {
                  rejection: f[R],
                  promise: f
              })
          } catch {}
  ...
  class t {
      ...
      then(u, i) {
          ...
          let g = new h(se)
            , w = n.current;
          return this[q] == M ? this[R].push(w, g, u, i) : ee(this, w, g, u, i),
          g
      }
      catch(u) {
          ...
          h[E] = E;
          let g = n.current;
          return this[q] == M ? this[R].push(g, h, u, u) : ee(this, g, h, u, u),
          h
      }
  }
  t.resolve = t.resolve,
...
function Et(e, n, c, r) {
  ...
  function J(R, E) {
      ...
      !T || T[b])
          return !1;
      let x = E && E.eventNameToString, d = {}, N = T[b] = T[a], P = T[A(l)] = T[l], K = T[A(y)] = T[y], oe = T[A(_)] = T[_], z;
        ...
        , u = function(i, h, g, w, p=!1, C=!1) {
          return function() {
              ...
              let fe = _e && !!f && f.indexOf(D) !== -1
                , Q = U(arguments[2], fe)
                , ye = Q && typeof Q == "object" && Q.signal && typeof Q.signal == "object" ? Q.signal : void 0;
              if (ye?.aborted)
                  return;
              if (F) {
              ...
              if (de) {
                  ...
                  de = S[Fe] = [];
              let ve, Ue = S.constructor.name, We = et[Ue];
              We && (ve = We[D]),
              ve || (ve = Ue + h + (x ? x(D) : D)),
              d.options = Q,
              Ve && (d.options.once = !1),
              ...
              let me = $ ? _t : void 0;
              me && (me.taskData = d),
              ye && (d.options.signal = void 0);
              let ie = it.scheduleEventTask(ve, G, me, g, w);
              if (ye && (d.options.signal = ye,
              i.call(ye, "abort", () => {
      ...
      return b && b.prototype && a.forEach(function(m) {
          ...
          try {
              if (O.hasOwnProperty(m)) {
                  ...
                  e._redefineProperty(b.prototype, m, Z)) : O[m] && (O[m] = e.wrapWithCurrentZone(O[m], I))
              } else
...
function mt(e, n) {
  if (Re && !Ke || Zone[e.symbol("patchEvents")])
      return;
...
function Ee(e, n, c, r) {
      ...
      if (typeof I[0] == "function") {
          ...
          I[0] = function() {
              try {
                  ...
                  O.isPeriodic || (typeof O.handleId == "number" ? delete y[O.handleId] : O.handleId && (O.handleId[be] = null))
              }
          }
          ;
          ...
          return typeof j == "number" ? y[j] = B : j && (j[be] = B),
          j && j.ref && j.unref && typeof j.ref == "function" && typeof j.unref == "function" && (B.ref = j.ref.bind(j),
  ...
  l = ue(e, c, k => function(m, I) {
      let O = I[0], Z;
      typeof O == "number" ? Z = y[O] : (Z = O && O[be],
      Z || (Z = O)),
      Z && typeof Z.type == "string" ? Z.state !== "notScheduled" && (Z.cancelFn && Z.data.isPeriodic || Z.runCount === 0) && (typeof O == "number" ? delete y[O] : O && (O[be] = null),
      Z.zone.cancelTask(Z)) : k.apply(e, I)
  }
  )
}
function gt(e, n) {
...
Zone.__load_patch("geolocation", e => {
  e.navigator && e.navigator.geolocation && ut(e.navigator.geolocation, ["getCurrentPosition", "watchPosition"])
}
);
Zone.__load_patch("PromiseRejectionEvent", (e, n) => {
  ...
  e.PromiseRejectionEvent && (n[A("unhandledPromiseRejectionHandler")] = c("unhandledrejection"),
